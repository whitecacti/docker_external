...
if [ "$CYPRESS_CONFIG" == "true" ]; then
    ...
    export SUPERSET__SQLALCHEMY_DATABASE_URI=postgresql+psycopg2://${POSTGRES_USER}:${POSTGRES_PASSWORD}@db_superset:${DATABASE_PORT}/superset_cypress
    PORT=${CYPRESS_INTERNAL_PORTS}
fi
